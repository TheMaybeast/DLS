...
namespace DLS
{
    public class SirenSetting
    {
        ...
        public string TextureName { get; set; } = DLS.TextureHash.defaultLightTexture;

        [XmlIgnore]
        public uint TextureHash
        {
            get => DLS.TextureHash.StringToHash(TextureName);

            set => TextureName = DLS.TextureHash.HashToString(value);
        }
